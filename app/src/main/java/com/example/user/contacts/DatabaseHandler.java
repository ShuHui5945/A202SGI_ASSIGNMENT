...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_CONTACTS + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_NAME + " TEXT," + KEY_PHONE + " TEXT," + KEY_EMAIL + " TEXT," + KEY_ADDRESS + " TEXT," + KEY_IMAGE + " TEXT)");
    }
    ...
    public void createContact(Contact contact) {
        ...
        values.put(KEY_IMAGE, contact.getImage().toString());
    ...
    public Contact getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_ID, KEY_NAME, KEY_PHONE, KEY_EMAIL, KEY_ADDRESS, KEY_IMAGE }, KEY_ID + "=?", new String[] { String.valueOf(id) }, null, null, null, null );
